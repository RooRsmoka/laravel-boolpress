    ...
    <div>
        ...
        <div v-if="!formSubmitted">
            ...
            <div class="mb-3">
                ...
                <input type="file" class="form-control" id="exampleFormControlInput3" @change="attachmentChange"/>
                <span class="text-danger" v-if="formValidationErrors && formValidationErrors.attachment">
